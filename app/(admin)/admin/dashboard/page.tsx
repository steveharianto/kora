...
export default async function AdminDashboardPage({
  ...
  return (
    <div className="max-w-[1250px] pb-24 font-sans text-ink space-y-6">
      ...
      {/* =================================================================== */}
      {/* 2. TOP GRID: REVENUE TREND & TOP DRESSES                            */}
      {/* =================================================================== */}
              ...
              metrics.topDresses.map((dress, idx) => {
                ...
                return (
                  <div key={idx} className="flex items-center justify-between gap-3">
                    ...
                    <span className="w-16 text-right text-muted font-mono">
                      {(dress.revenue / 1000000).toFixed(1)} jt
                    </span>
                  </div>
                );
              })
      ...
      {/* =================================================================== */}
      {/* 4. BOTTOM GRID: DAILY OPERATIONAL TRIAGE                            */}
      {/* =================================================================== */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-card border border-line rounded-[10px] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.02)] flex flex-col justify-between">
          ...
          <div className="pt-4 mt-4 border-t border-line">
            <Link
              href="/admin/orders"
              className="text-xs font-semibold text-wine-ink hover:underline"
            >
              Open Orders →
            </Link>
          </div>

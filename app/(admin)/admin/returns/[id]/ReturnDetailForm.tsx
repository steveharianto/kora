...
export default function ReturnDetailForm({
  ...
  const calculatedRefund = useMemo(() => {
    return Math.max(0, depositHeld - qcDeduction - returnShippingCost);
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        ...
        {/* RIGHT CARDS: RETURN REQUEST & SHIPMENT */}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 pt-2">
              <div>
                ...
                <input
                  disabled
                  value={depositHeld}
                  className="w-full text-xs border border-line rounded-lg px-3 py-2 bg-[#F6F4EF] text-ink font-bold"
                />
              </div>
              ...
              <div>
                ...
                <input
                  disabled
                  value={calculatedRefund}
                  className="w-full text-xs border border-line rounded-lg px-3 py-2 bg-[#F6F4EF] text-wine-ink font-bold"
                />
              </div>
            </div>

            {/* Payout Target & Reason */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
              ...
              <div>
                ...
                <input
                  disabled={isCompleted}
                  placeholder="e.g., light stain on hem, 2 days late"

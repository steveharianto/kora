    ...
    <div>
      <form onSubmit={handleSubmit}>
        <div className="flex items-end justify-between mb-6 gap-4 flex-wrap">
          ...
          >
            {loading ? 'Processing...' : isSuperAdmin ? 'Save item' : 'Req Save'}
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="bg-card border border-line rounded-[10px] p-5 space-y-3.5">
            <h3 className="font-serif text-[18px] font-normal mb-1">Item information</h3>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] text-muted">Click suggestion or type below</span>
              </div>
              ...
              >
                {formData.tags.map((tag: string, i: number) => (
                  <span key={i} className="inline-flex items-center gap-1 bg-wine-soft text-wine-ink text-[12px] px-2 py-0.5 rounded-full">
                    {tag}
                    <button
                      type="button"
                ...
                <input
                  ...
                  placeholder={formData.tags.length === 0 ? "Type custom style tag and press enter..." : ""}
          ...
          <div className="space-y-4">
            <div className="bg-card border border-line rounded-[10px] p-5">
              <h3 className="font-serif text-[18px] font-normal mb-3">Pictures <span className="text-bad">*</span></h3>
